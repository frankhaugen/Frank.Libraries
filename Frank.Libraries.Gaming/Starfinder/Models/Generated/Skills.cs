...
namespace Frank.Libraries.Gaming.Starfinder.Models.Generated{ 
    ...
    public class Skills
    {
        ...
        [JsonPropertyName("gunnery")]
        public Gunnery Gunnery { get; set; }

        [JsonPropertyName("intimidate")]
        ...
        public Piloting Piloting { get; set; }

        [JsonPropertyName("life-science")]
        public LifeScience LifeScience { get; set; }

        [JsonPropertyName("physical-science")]
        public PhysicalScience PhysicalScience { get; set; }
        ...
        [JsonPropertyName("mysticism")]
        public Mysticism Mysticism { get; set; }
    }
