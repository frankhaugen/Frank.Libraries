...
public static class FluentCalculatorExponentialOperations
{
    ...
    {
        if (source is 0 or (int)DecimalConstants.SmallestNonZeroDec)
        {
            return 0;
        }
    ...
    {
        if (source is 0 or (uint)DecimalConstants.SmallestNonZeroDec)
        {
            return 0;
        }
    ...
    {
        if (source is 0 or (short)DecimalConstants.SmallestNonZeroDec)
        {
            return 0;
        }
    ...
    {
        if (source is 0 or (ushort)DecimalConstants.SmallestNonZeroDec)
        {
            return 0;
        }
    ...
    {
        if (source is 0 or (long)DecimalConstants.SmallestNonZeroDec)
        {
            return 0;
        }
    ...
    {
        if (source is 0 or (ulong)DecimalConstants.SmallestNonZeroDec)
        {
            return 0;
        }
    ...
    {
        if (source is 0 or (float)DecimalConstants.SmallestNonZeroDec)
        {
            return 0;
        }
    ...
    {
        if (source is 0 or (double)DecimalConstants.SmallestNonZeroDec)
        {
            return 0;
        }
        ...
        var lastX = (double)-1;
        double nextX;
        var x = Math.Sqrt(Convert.ToDouble(source));
        while (true)
        {
            nextX = x / 2 + halfS / x;
            if (nextX == x || nextX == lastX)
    ...
    {
        if (source is 0 or DecimalConstants.SmallestNonZeroDec)
        {
            return 0;
        }
