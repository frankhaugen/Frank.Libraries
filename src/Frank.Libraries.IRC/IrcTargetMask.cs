...
public class IrcTargetMask : IIrcMessageTarget
{
    ...
    ///     A wildcard expression for matching against server names or host names. If the first character
    ///     is '$', the mask is a server mask; if the first character is '#', the mask is a host mask.
    /// </param>
    ...
    /// <summary>
    ///     Gets a wildcard expression for matching against target names. The <see cref="Type" /> property determines the type
    ///     of the mask.
    /// </summary>
