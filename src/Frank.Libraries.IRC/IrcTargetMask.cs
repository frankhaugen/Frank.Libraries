...
namespace Frank.Libraries.IRC
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IrcTargetMask"/> class with the specified target mask identifier.
        /// </summary>
        /// <param name="targetMask">A wildcard expression for matching against server names or host names. If the first character is '$', the mask is a server mask; if the first character is '#', the mask is a host mask.</param>
        ...
        /// <exception cref="ArgumentException"><paramref name="targetMask"/> does not represent a known mask type.</exception>
        ...
        /// <summary>
        /// Gets a wildcard expression for matching against target names. The <see cref="Type"/> property determines the type of the mask.
        /// </summary>
