...
public class IrcChannelCollection : ReadOnlyCollection<IrcChannel>
{
    ...
    public void Join(params string[] channels) => Join((IEnumerable<string>)channels);
    ...
    public void Join(IEnumerable<string> channels) => Client.Join(channels);

    /// <inheritdoc cref="Join(IEnumerable{Tuple{string, string}})" />
    public void Join(params Tuple<string, string>[] channels) => Join((IEnumerable<Tuple<string, string>>)channels);
    ...
    public void Join(IEnumerable<Tuple<string, string>> channels) => Client.Join(channels);

    /// <inheritdoc cref="Leave(IEnumerable{string}, string)" />
    public void Leave(params string[] channels) => Leave((IEnumerable<string>)channels);
    ...
    ///     no comment.
    /// </param>
    public void Leave(IEnumerable<string> channels, string comment = null) => Client.Leave(channels, comment);
}