...
public class IrcUser : INotifyPropertyChanged, IIrcMessageSource, IIrcMessageTarget
{
    ...
    string IIrcMessageSource.Name => NickName;

    string IIrcMessageTarget.Name => NickName;
    ...
    /// </summary>
    public void WhoIs() => client.QueryWhoIs(nickName);
    ...
    /// </param>
    public void WhoWas(int entriesCount = -1) => client.QueryWhoWas(new[] { nickName }, entriesCount);
