...
partial class CtcpClient
{
    ...
    ///     otherwise.
    /// </param>
    protected void SendMessageTime(IList<IIrcMessageTarget> targets, string info, bool isResponse) => WriteMessage(targets, "time", info, isResponse);
    ...
    ///     otherwise.
    /// </param>
    protected void SendMessageVersion(IList<IIrcMessageTarget> targets, string info, bool isResponse) => WriteMessage(targets, "version", info, isResponse);
    ...
    ///     otherwise.
    /// </param>
    protected void SendMessageErrMsg(IList<IIrcMessageTarget> targets, string tag, bool isResponse) => WriteMessage(targets, "errmsg", tag, isResponse);
    ...
    ///     otherwise.
    /// </param>
    protected void SendMessagePing(IList<IIrcMessageTarget> targets, string info, bool isResponse) => WriteMessage(targets, "ping", info, isResponse);
}