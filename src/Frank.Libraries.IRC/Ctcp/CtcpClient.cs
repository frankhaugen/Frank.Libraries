...
/// <summary>
///     Represents a client that communicates with a server using CTCP (Client to Client Protocol), operating over an IRC
///     connection. Do not inherit this class unless the protocol itself is being extended.
/// </summary>
/// <remarks>
...
public partial class CtcpClient
{
    ...
    public void SendAction(IIrcMessageTarget user, string text) => SendMessageAction(new[] { user }, text);
    ...
    public void SendAction(IList<IIrcMessageTarget> users, string text) => SendMessageAction(users, text);
    ...
    /// </summary>
    /// <param name="user">The user to which to send the request.</param>
    public void GetTime(IIrcMessageTarget user) => GetTime(new[] { user });

    /// <summary>
    ///     Gets the local date/time of the specified list of users.
    /// </summary>
    /// <param name="users">A list of users to which to send the request.</param>
    public void GetTime(IList<IIrcMessageTarget> users) => SendMessageTime(users, null, false);
    ...
    /// </summary>
    /// <param name="user">The user to which to send the request.</param>
    public void GetVersion(IIrcMessageTarget user) => GetVersion(new[] { user });

    /// <summary>
    ///     Gets the client version of the specified list of users.
    /// </summary>
    /// <param name="users">A list of users to which to send the request.</param>
    public void GetVersion(IList<IIrcMessageTarget> users) => SendMessageVersion(users, null, false);
    ...
    /// </summary>
    /// <param name="user">The user to which to send the request.</param>
    public void CheckErrorOccurred(IIrcMessageTarget user) => CheckErrorOccurred(new[] { user });

    /// <summary>
    ///     Asks the specified list of users whether an error just occurred.
    /// </summary>
    /// <param name="users">A list of users to which to send the request.</param>
    public void CheckErrorOccurred(IList<IIrcMessageTarget> users) => SendMessageErrMsg(users, noErrorTag, false);
    ...
    /// </summary>
    /// <param name="user">The user to which to send the request.</param>
    public void Ping(IIrcMessageTarget user) => Ping(new[] { user });

    /// <summary>
    ///     Pings the specified list of users.
    /// </summary>
    /// <param name="users">A list of users to which to send the request.</param>
    public void Ping(IList<IIrcMessageTarget> users) => SendMessagePing(users, DateTime.Now.Ticks.ToString(), false);
    ...
    private void ircClient_LocalUser_PreviewMessageReceived(object sender, IrcPreviewMessageEventArgs e) => ReadMessage(e, false);
    ...
    ///     The value of <see cref="CtcpMessage.Tag" /> of <paramref name="message" /> is
    ///     invalid.
    /// </exception>
    ...
    private string LowLevelQuote(string value) => value.Quote(lowLevelQuotingEscapeChar, lowLevelQuotedChars);

    private string LowLevelDequote(string value) => value.Dequote(lowLevelQuotingEscapeChar, lowLevelDequotedChars);

    private string CtcpQuote(string value) => value.Quote(ctcpQuotingEscapeChar, ctcpQuotedChars);

    private string CtcpDequote(string value) => value.Dequote(ctcpQuotingEscapeChar, ctcpDequotedChars);
    ...
    /// </summary>
    /// <param name="e">The <see cref="CtcpTimeResponseReceivedEventArgs" /> instance containing the event data.</param>
    ...
    /// </summary>
    /// <param name="e">The <see cref="CtcpErrorMessageReceivedEventArgs" /> instance containing the event data.</param>
    ...
    public override string ToString() => string.Format("CTCP / {0}", IrcClient);
    ...
    public struct CtcpMessage
    {
        ...
        /// <summary>
        ///     <see langword="true" /> if this message is a response to another message; <see langword="false" />, otherwise.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A string that represents this instance.</returns>
        public override string ToString() => string.Format("{0} {1}", Tag, Data);
    }
}