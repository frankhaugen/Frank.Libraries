...
{
    /// <summary>
    /// Represents a client that communicates with a server using CTCP (Client to Client Protocol), operating over an IRC connection. Do not inherit this class unless the protocol itself is being extended.
    /// </summary>
    ...
    public partial class CtcpClient
    {
        ...
        /// <exception cref="ArgumentException">The value of <see cref="CtcpMessage.Tag"/> of <paramref name="message"/> is invalid.</exception>
