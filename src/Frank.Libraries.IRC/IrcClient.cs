...
namespace Frank.Libraries.IRC
{
    ...
    /// </summary>
    /// <remarks>All collection objects must be locked on the <see cref="ICollection.SyncRoot"/> object for thread-safety. They can however be used safely without locking within event handlers.</remarks>
    ...
    public abstract partial class IrcClient : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets an object that limits the rate of outgoing messages in order to prevent flooding the server. The value is <see langword="null"/> by default, which indicates that no flood prevention should be performed.
        /// </summary>
        ...
        /// </summary>
        /// <value><see langword="true"/> if the <see cref="IrcClient"/> object has been disposed; <see langword="false"/>, otherwise.</value>
        ...
        /// </summary>
        /// <param name="disposing"><see langword="true"/> if the consumer is actively disposing the object; <see langword="false"/> if the garbage collector is finalizing the object.</param>
        ...
        /// </summary>
        /// <remarks>Note that the <see cref="LocalUser"/> object is not yet set when this event occurs, but is only accessible when the <see cref="Registered"/> event is raised.</remarks>
        ...
        /// </summary>
        /// <remarks>Client information is accessible via <see cref="WelcomeMessage"/>, <see cref="YourHostMessage"/>, <see cref="ServerCreatedMessage"/>, <see cref="ServerName"/>, <see cref="ServerVersion"/>, <see cref="ServerAvailableUserModes"/>, and <see cref="ServerAvailableChannelModes"/>.</remarks>
        ...
        /// </summary>
        /// <param name="channelNames">The names of the channels to list, or <see langword="null"/> to list all channels on the network.</param>
        ...
        /// </summary>
        /// <param name="targetServer">The name of the server from which to request the MOTD, or <see langword="null"/> for the current server.</param>
        ...
        /// <summary>
        /// Requests statistics about the connected IRC network. If <paramref name="serverMask"/> is specified, then the server only returns information about the part of the network formed by the servers whose names match the mask; otherwise, the information concerns the whole network
        /// </summary>
        /// <param name="serverMask">A wildcard expression for matching against server names, or <see langword="null"/> to match the entire network.</param>
        ...
        /// </summary>
        /// <param name="query">The query character that indicates which server statistics to return. The set of valid query characters is dependent on the implementation of the particular IRC server.</param>
        ...
        /// <summary>
        /// Requests a list of all servers known by the target server. If <paramref name="serverMask"/> is specified, then the server only returns information about the part of the network formed by the servers whose names match the mask; otherwise, the information concerns the whole network.
        /// </summary>
        /// <param name="serverMask">A wildcard expression for matching against server names, or <see langword="null"/> to match the entire network.</param>
        /// <param name="targetServer">The name of the server to which to forward the request, or <see langword="null"/> for the current server.</param>
        /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
        ...
        /// </summary>
        /// <param name="mask">A wildcard expression for matching against channel names; or if none can be found, host names, server names, real names, and nick names of users. If the value is <see langword="null"/>, all users are matched.</param>
        ...
        /// <param name="entriesCount">The maximum number of entries to return from the query. A negative value specifies to return an unlimited number of entries.</param>
        /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
        ...
        /// <remarks>Note that because this message is not sent immediately, calling <see cref="Disconnect"/> immediately after this will likely disconnect the client before it has a chance to quit the server properly. Quitting the server should automatically disconnect the client.</remarks>
        /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
        ...
        /// </summary>
        /// <param name="messageParameters">A collection of message parameters, which consists of mode strings and mode parameters. A mode string is of the form `( "+" / "-" ) *( mode character )`, and specifies mode changes. A mode parameter is arbitrary text associated with a certain mode.</param>
        /// <returns>A 2-tuple of a single mode string and a collection of mode parameters. Each mode parameter corresponds to a single mode character, in the same order.</returns>
        ...
        /// <summary>
        /// Gets the target of a message from the specified name. A message target may be an <see cref="IrcUser"/>, <see cref="IrcChannel"/>, or <see cref="IrcTargetMask"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the source of a message from the specified prefix. A message source may be a <see cref="IrcUser"/> or <see cref="IrcServer"/>.
        /// </summary>
        /// <param name="prefix">The raw prefix of the message.</param>
        /// <returns>The message source that corresponds to the specified prefix. The object is an instance of <see cref="IrcUser"/> or <see cref="IrcServer"/>.</returns>
        ...
        /// <param name="createdNew"><see langword="true"/> if the server object was created during the call; <see langword="false"/>, otherwise.</param>
        ...
        /// <param name="createdNew"><see langword="true"/> if the channel object was created during the call; <see langword="false"/>, otherwise.</param>
        ...
        /// <param name="isOnline"><see langword="true"/> if the user is currently online; <see langword="false"/>, if the user is currently offline. The <see cref="IrcUser.IsOnline"/> property of the user object is set to this value.</param>
        /// <param name="createdNew"><see langword="true"/> if the user object was created during the call; <see langword="false"/>, otherwise.</param>
        ...
        /// <exception cref="ArgumentException">The value of <see cref="IrcMessage.Command"/> of <paramref name="message"/> is invalid.</exception>
        /// <exception cref="ArgumentException">The value of one of the items of <see cref="IrcMessage.Parameters"/> of <paramref name="message"/> is invalid.</exception>
        /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
        ...
        /// </summary>
        /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
        /// <remarks>This method closes the client connection immediately and forcibly, and does not send a quit message to the server. To disconnect from the IRC server gracefully, call <see cref="Quit(string)"/> and wait for the connection to be closed.</remarks>
        ...
        /// <summary>
        /// Represents a raw IRC message that is sent/received by <see cref="IrcClient"/>. A message contains a prefix (representing the source), a command name (a word or three-digit number), and any number of parameters (up to a maximum of 15).
        /// </summary>
