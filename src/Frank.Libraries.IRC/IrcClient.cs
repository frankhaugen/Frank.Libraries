...
using Frank.Libraries.IRC.Collections;
using Frank.Libraries.IRC.Properties;

namespace Frank.Libraries.IRC;

/// <summary>
///     Represents a client that communicates with a server using the IRC (Internet Relay Chat) protocol. Do not inherit
///     this class unless the protocol itself is being extended.
/// </summary>
/// <remarks>
...
public abstract partial class IrcClient : IDisposable
{
    ...
    /// </summary>
    /// <value><see langword="true" /> if the connection has been registered; <see langword="false" />, otherwise.</value>
    ...
    /// <summary>
    ///     Gets a collection of the user modes available on the server. This value is set after successful registration of the
    ///     connection.
    /// </summary>
    ...
    /// <summary>
    ///     Gets a collection of the channel modes available on the server. This value is set after successful registration of
    ///     the connection.
    /// </summary>
    ...
    /// <summary>
    ///     Gets a dictionary of the features supported by the server, keyed by feature name, as returned by the ISUPPORT
    ///     message. This value is set after successful registration of the connection.
    /// </summary>
    ...
    /// <summary>
    ///     Gets the Message of the Day (MOTD) sent by the server. This value is set after successful registration of the
    ///     connection.
    /// </summary>
    ...
    /// <summary>
    ///     Gets information about the IRC network that is given by the server. This value is set after successful registration
    ///     of the connection.
    /// </summary>
    /// <value>The Message of the Day sent by the server.</value>
    ...
    /// <summary>
    ///     Gets or sets an object that limits the rate of outgoing messages in order to prevent flooding the server. The value
    ///     is <see langword="null" /> by default, which indicates that no flood prevention should be performed.
    /// </summary>
    ...
    /// </summary>
    /// <value>
    ///     <see langword="true" /> if the <see cref="IrcClient" /> object has been disposed; <see langword="false" />,
    ///     otherwise.
    /// </value>
    ...
    /// <summary>
    ///     Occurs when the SSL certificate received from the server should be validated. The certificate is automatically
    ///     validated if this event is not handled.
    /// </summary>
    ...
    /// </summary>
    /// <remarks>The <see cref="LocalUser" /> object is set when this event occurs.</remarks>
    ...
    /// <summary>
    ///     Occurs when a list of features supported by the server (ISUPPORT) has been received. This event may be raised more
    ///     than once after registration, depending on the size of the list received.
    /// </summary>
    public event EventHandler<EventArgs> ServerSupportedFeaturesReceived;

    /// <summary>
    ///     Occurs when a ping query is received from the server. The client automatically replies to pings from the server;
    ///     this event is only a notification.
    /// </summary>
    ...
    ///     The names of the channels to list, or <see langword="null" /> to list all channels on the
    ///     network.
    /// </param>
    ...
    ///     The name of the server from which to request the MOTD, or <see langword="null" /> for the
    ///     current server.
    /// </param>
    ...
    /// <summary>
    ///     Requests statistics about the connected IRC network. If <paramref name="serverMask" /> is specified, then the
    ///     server only returns information about the part of the network formed by the servers whose names match the mask;
    ///     otherwise, the information concerns the whole network
    /// </summary>
    /// <param name="serverMask">
    ///     A wildcard expression for matching against server names, or <see langword="null" /> to match
    ///     the entire network.
    /// </param>
    /// <param name="targetServer">
    ///     The name of the server to which to forward the message, or <see langword="null" /> for the
    ///     current server.
    /// </param>
    /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
    ...
    /// </summary>
    /// <param name="query">
    ///     The query character that indicates which server statistics to return. The set of valid query
    ///     characters is dependent on the implementation of the particular IRC server.
    /// </param>
    /// <param name="targetServer">The name of the server whose statistics to request.</param>
    /// <remarks>The server may not accept the command if <paramref name="query" /> is unspecified.</remarks>
    /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
    ...
    /// <summary>
    ///     Requests a list of all servers known by the target server. If <paramref name="serverMask" /> is specified, then the
    ///     server only returns information about the part of the network formed by the servers whose names match the mask;
    ///     otherwise, the information concerns the whole network.
    /// </summary>
    /// <param name="serverMask">
    ...
    /// </param>
    /// <param name="targetServer">
    ///     The name of the server to which to forward the request, or <see langword="null" /> for the
    ///     current server.
    /// </param>
    /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
    ...
    /// </summary>
    /// <param name="mask">
    ///     A wildcard expression for matching against channel names; or if none can be found, host names,
    ///     server names, real names, and nick names of users. If the value is <see langword="null" />, all users are matched.
    /// </param>
    /// <param name="onlyOperators">
    ///     <see langword="true" /> to match only server operators; <see langword="false" /> to match
    ///     all users.
    /// </param>
    /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
    ...
    /// </summary>
    /// <param name="nickNameMasks">A collection of wildcard expressions for matching against nick names of users.</param>
    /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
    ...
    ///     The maximum number of entries to return from the query. A negative value specifies to return
    ...
    ///     this will likely disconnect the client before it has a chance to quit the server properly. Quitting the server
    ///     should automatically disconnect the client.
    /// </remarks>
    /// <exception cref="ObjectDisposedException">The current instance has already been disposed.</exception>
    ...
    /// <summary>
    ///     Gets a collection of mode characters and mode parameters from the specified mode parameters. Combines multiple mode
    ///     strings into a single mode string.
    /// </summary>
    /// <param name="messageParameters">
    ///     A collection of message parameters, which consists of mode strings and mode parameters.
    ///     A mode string is of the form `( "+" / "-" ) *( mode character )`, and specifies mode changes. A mode parameter is
    ///     arbitrary text associated with a certain mode.
    /// </param>
    /// <returns>
    ///     A 2-tuple of a single mode string and a collection of mode parameters. Each mode parameter corresponds to a
    ///     single mode character, in the same order.
    /// </returns>
    ...
    /// <returns><see langword="true" /> if the specified name represents a channel; <see langword="false" />, otherwise.</returns>
    ...
    /// </summary>
    /// <param name="type">
    ///     A character that represents the type of the channel. The character may be one of the following:
    ///     <list type="bullet">
    ///         <listheader>
    ///             <term>Character</term>
    ...
    /// <exception cref="ArgumentException"><paramref name="type" /> does not correspond to any known channel type.</exception>
    ...
    /// <summary>
    ///     Gets the target of a message from the specified name. A message target may be an <see cref="IrcUser" />,
    ///     <see cref="IrcChannel" />, or <see cref="IrcTargetMask" />.
    /// </summary>
    /// <param name="targetName">The name of the target.</param>
    /// <returns>The target object that corresponds to the given name.</returns>
    /// <exception cref="ArgumentException"><paramref name="targetName" /> does not represent a valid message target.</exception>
    protected IIrcMessageTarget GetMessageTarget(string targetName)
    {
        ...
        if (nickName != null)
        {
            ...
            var user = GetUserFromNickName(nickName);
    ...
    /// <summary>
    ///     Gets the source of a message from the specified prefix. A message source may be a <see cref="IrcUser" /> or
    ///     <see cref="IrcServer" />.
    /// </summary>
    ...
    /// </returns>
    /// <exception cref="ArgumentException"><paramref name="prefix" /> does not represent a valid message source.</exception>
    ...
    /// <param name="isOnline">
    ///     <see langword="true" /> if the user is currently online; <see langword="false" />, if the user
    ///     is currently offline. The <see cref="IrcUser.IsOnline" /> property of the user object is set to this value.
    /// </param>
    /// <param name="createdNew">
    ...
    /// <exception cref="ArgumentException"><paramref name="message" /> contains more than 15 many parameters.</exception>
    /// <exception cref="ArgumentException">
    ///     The value of <see cref="IrcMessage.Command" /> of <paramref name="message" /> is
    ///     invalid.
    /// </exception>
    /// <exception cref="ArgumentException">
    ...
    private bool IsInvalidMessageChar(char value) => value == '\0' || value == '\r' || value == '\n';
    ...
    ///     server. To disconnect from the IRC server gracefully, call <see cref="Quit(string)" /> and wait for the connection
    ///     to be closed.
    /// </remarks>
    public virtual void Disconnect() => CheckDisposed();
    ...
    protected void ParseMessage(string line)
    {
        ...
        // Extract parameters from message. Each parameter is separated by single space, except last one, which may contain spaces if it is prefixed by colon.
    ...
    protected void HandleClientConnecting() => DebugUtilities.WriteEvent("Connecting to server...");
    ...
    protected virtual void HandleClientDisconnected() => OnDisconnected(new EventArgs());
    ...
    /// </summary>
    /// <param name="e">The <see cref="IrcValidateSslCertificateEventArgs" /> instance containing the event data.</param>
    ...
    /// </summary>
    /// <param name="e">The <see cref="IrcServerLinksListReceivedEventArgs" /> instance containing the event data.</param>
    ...
    /// </summary>
    /// <param name="e">The <see cref="IrcServerStatsReceivedEventArgs" /> instance containing the event data.</param>
    ...
    /// </summary>
    /// <param name="e">The <see cref="IrcChannelListReceivedEventArgs" /> instance containing the event data.</param>
    ...
    internal void SetTopic(string channel, string topic = null) => SendMessageTopic(channel, topic);
    ...
    internal void Kick(IEnumerable<IrcChannelUser> channelUsers, string comment = null) => SendMessageKick(channelUsers.Select(cu => Tuple.Create(cu.Channel.Name, cu.User.NickName)), comment);

    internal void Join(IEnumerable<string> channels) => SendMessageJoin(channels);

    internal void Join(IEnumerable<Tuple<string, string>> channels) => SendMessageJoin(channels);

    internal void Leave(IEnumerable<string> channels, string comment = null) => SendMessagePart(channels, comment);
    ...
    internal void SetAway(string text) => SendMessageAway(text);

    internal void UnsetAway() => SendMessageAway();

    internal void SetNickName(string nickName) => SendMessageNick(nickName);
    ...
    /// <summary>
    ///     Represents a raw IRC message that is sent/received by <see cref="IrcClient" />. A message contains a prefix
    ///     (representing the source), a command name (a word or three-digit number), and any number of parameters (up to a
    ///     maximum of 15).
    /// </summary>
    ...
    public struct IrcMessage
    {
        ...
        /// <param name="parameters">A list of the parameters to the message. Can contain a maximum of 15 items.</param>
