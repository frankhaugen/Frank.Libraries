...
public class IrcChannel : INotifyPropertyChanged, IIrcMessageTarget, IIrcMessageReceiveHandler, IIrcMessageReceiver
{
    ...
    string IIrcMessageTarget.Name => Name;
    ...
    public void Invite(IrcUser user) => Invite(user.NickName);

    /// <summary>
    ///     Invites the the specified user to the channel.
    /// </summary>
    /// <param name="userNickName">The nick name of the user to invite.</param>
    public void Invite(string userNickName) => client.Invite(this, userNickName);
    ...
    public void Kick(string userNickName, string comment = null) => client.Kick(this, new[] { userNickName }, comment);

    /// <summary>
    ///     Requests the current topic of the channel.
    /// </summary>
    public void GetTopic() => client.SetTopic(Name);

    /// <summary>
    ///     Sets the topic of the channel to the specified text.
    /// </summary>
    /// <param name="newTopic">The new topic to set.</param>
    public void SetTopic(string newTopic) => client.SetTopic(Name, newTopic);
    ...
    /// </param>
    public void GetModes(string modes = null) => client.GetChannelModes(this, modes);
    ...
    ///     no comment.
    /// </param>
    public void Leave(string comment = null) => client.Leave(new[] { Name }, comment);
    ...
    internal void HandleTypeChanged(IrcChannelType type) => Type = type;

    internal void HandleUsersListReceived() => OnUsersListReceived(new EventArgs());
