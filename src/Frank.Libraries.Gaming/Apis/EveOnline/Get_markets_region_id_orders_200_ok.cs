...
{
    [JsonConstructor]
    public Get_markets_region_id_orders_200_ok(int duration, bool is_buy_order, DateTimeOffset issued, long location_id, int min_volume, long order_id, double price, Get_markets_region_id_orders_200_okRange range, int system_id, int type_id, int volume_remain, int volume_total)
