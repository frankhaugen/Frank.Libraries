...
public record Get_corporations_corporation_id_contracts_200_ok
{
    [JsonConstructor]
    public Get_corporations_corporation_id_contracts_200_ok(int acceptor_id, int assignee_id, Get_corporations_corporation_id_contracts_200_okAvailability availability, double? buyout, double? collateral, int contract_id, DateTimeOffset? date_accepted, DateTimeOffset? date_completed, DateTimeOffset date_expired, DateTimeOffset date_issued, int? days_to_complete, long? end_location_id, bool for_corporation, int issuer_corporation_id, int issuer_id, double? price, double? reward, long? start_location_id, Get_corporations_corporation_id_contracts_200_okStatus status, string? title, Get_corporations_corporation_id_contracts_200_okType type, double? volume)
    ...
    public Get_corporations_corporation_id_contracts_200_okAvailability Availability { get; init; }
    ...
    [JsonConverter(typeof(JsonStringEnumConverter))]
    public Get_corporations_corporation_id_contracts_200_okStatus Status { get; init; }
    ...
    [JsonConverter(typeof(JsonStringEnumConverter))]
    public Get_corporations_corporation_id_contracts_200_okType Type { get; init; }
