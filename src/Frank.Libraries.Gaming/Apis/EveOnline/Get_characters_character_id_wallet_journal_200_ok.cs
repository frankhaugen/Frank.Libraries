...
{
    [JsonConstructor]
    public Get_characters_character_id_wallet_journal_200_ok(double? amount, double? balance, long? context_id, Get_characters_character_id_wallet_journal_200_okContext_id_type? context_id_type, DateTimeOffset date, string description, int? first_party_id, long id, string? reason, Get_characters_character_id_wallet_journal_200_okRef_type ref_type, int? second_party_id, double? tax, int? tax_receiver_id)
