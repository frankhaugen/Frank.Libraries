namespace EveOnlineApi;
    ...
    public record Get_corporations_corporation_id_killmails_recent_200_ok
    {
        [System.Text.Json.Serialization.JsonConstructor]

        public Get_corporations_corporation_id_killmails_recent_200_ok(string @killmail_hash, int @killmail_id)
