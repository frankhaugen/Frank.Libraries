namespace EveOnlineApi;
    ...
    public record Get_characters_character_id_contracts_contract_id_items_200_ok
    {
        [System.Text.Json.Serialization.JsonConstructor]

        public Get_characters_character_id_contracts_contract_id_items_200_ok(bool @is_included, bool @is_singleton, int @quantity, int? @raw_quantity, long @record_id, int @type_id)
