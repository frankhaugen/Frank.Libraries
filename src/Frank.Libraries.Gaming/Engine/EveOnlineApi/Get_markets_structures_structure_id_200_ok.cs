namespace EveOnlineApi;
    ...
    public record Get_markets_structures_structure_id_200_ok
    {
        ...
        public Get_markets_structures_structure_id_200_ok(int @duration, bool @is_buy_order, System.DateTimeOffset @issued, long @location_id, int @min_volume, long @order_id, double @price, Get_markets_structures_structure_id_200_okRange @range, int @type_id, int @volume_remain, int @volume_total)
