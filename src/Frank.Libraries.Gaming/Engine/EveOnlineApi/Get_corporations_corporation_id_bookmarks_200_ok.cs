namespace EveOnlineApi;
    ...
    public record Get_corporations_corporation_id_bookmarks_200_ok
    {
        ...
        public Get_corporations_corporation_id_bookmarks_200_ok(int @bookmark_id, Coordinates2? @coordinates, System.DateTimeOffset @created, int @creator_id, int? @folder_id, Item2? @item, string @label, int @location_id, string @notes)
