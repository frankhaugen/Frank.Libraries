namespace EveOnlineApi;
    ...
    public record Get_characters_character_id_industry_jobs_200_ok
    {
        ...
        public Get_characters_character_id_industry_jobs_200_ok(int @activity_id, long @blueprint_id, long @blueprint_location_id, int @blueprint_type_id, int? @completed_character_id, System.DateTimeOffset? @completed_date, double? @cost, int @duration, System.DateTimeOffset @end_date, long @facility_id, int @installer_id, int @job_id, int? @licensed_runs, long @output_location_id, System.DateTimeOffset? @pause_date, float? @probability, int? @product_type_id, int @runs, System.DateTimeOffset @start_date, long @station_id, Get_characters_character_id_industry_jobs_200_okStatus @status, int? @successful_runs)
