...
namespace Frank.Libraries.Gaming.Starfinder.Models.Generated
{
    public class Root
    {
        [JsonPropertyName("ablativeArmorId")] public string AblativeArmorId { get; set; }
        ...
        [JsonPropertyName("armorId")] public string ArmorId { get; set; }

        [JsonPropertyName("armorMaterialId")] public string ArmorMaterialId { get; set; }
        ...
        [JsonPropertyName("crewQuartersId")] public string CrewQuartersId { get; set; }

        [JsonPropertyName("crewSkills")] public CrewSkills CrewSkills { get; set; }

        [JsonPropertyName("ctTim")] public int CtTim { get; set; }

        [JsonPropertyName("ctTimAll")] public int CtTimAll { get; set; }

        [JsonPropertyName("customFrameBaseId")]
        public string CustomFrameBaseId { get; set; }

        [JsonPropertyName("customComponents")] public List<object> CustomComponents { get; } = new List<object>();
        ...
        [JsonPropertyName("driftEngineId")] public string DriftEngineId { get; set; }

        [JsonPropertyName("expansionBayIds")] public List<string> ExpansionBayIds { get; } = new List<string>();

        [JsonPropertyName("fortifiedHullId")] public string FortifiedHullId { get; set; }
        ...
        [JsonPropertyName("hasAutoDestruct")] public int HasAutoDestruct { get; set; }
        ...
        [JsonPropertyName("hasCrew")] public bool HasCrew { get; set; }

        [JsonPropertyName("hasDataNet")] public int HasDataNet { get; set; }

        [JsonPropertyName("hasEmergencyAccelerator")]
        public int HasEmergencyAccelerator { get; set; }

        [JsonPropertyName("hasHiveJoining")] public int HasHiveJoining { get; set; }

        [JsonPropertyName("hasHolographicMantle")]
        public int HasHolographicMantle { get; set; }

        [JsonPropertyName("hasPowersap")] public int HasPowersap { get; set; }

        [JsonPropertyName("hasReconfigurationSystem")]
        public int HasReconfigurationSystem { get; set; }

        [JsonPropertyName("hasRootSystem")] public int HasRootSystem { get; set; }
        ...
        [JsonPropertyName("isUseStrictRules")] public bool IsUseStrictRules { get; set; }

        [JsonPropertyName("powerCoreIds")] public List<string> PowerCoreIds { get; } = new List<string>();

        [JsonPropertyName("powerCoreSpecialMaterials")]
        public List<string> PowerCoreSpecialMaterials { get; } = new List<string>();

        [JsonPropertyName("ctNetworkNodes")] public int CtNetworkNodes { get; set; }
        ...
        [JsonPropertyName("sensorsId")] public string SensorsId { get; set; }

        [JsonPropertyName("sensorsMaterialId")]
        public string SensorsMaterialId { get; set; }

        [JsonPropertyName("shieldType")] public string ShieldType { get; set; }

        [JsonPropertyName("shieldsByPosition")]
        public ShieldsByPosition ShieldsByPosition { get; set; }

        [JsonPropertyName("shieldsId")] public string ShieldsId { get; set; }

        [JsonPropertyName("shipConcept")] public string ShipConcept { get; set; }

        [JsonPropertyName("shipName")] public string ShipName { get; set; }

        [JsonPropertyName("sources")] public Sources Sources { get; set; }

        [JsonPropertyName("thrustersId")] public string ThrustersId { get; set; }
        ...
        [JsonPropertyName("tierId")] public string TierId { get; set; }

        [JsonPropertyName("version")] public string Version { get; set; }

        [JsonPropertyName("viId")] public string ViId { get; set; }
        ...
        [JsonPropertyName("weaponMounts")] public WeaponMounts WeaponMounts { get; set; }
    }
}