...
public static class EnumerableExtensions
{
    ...
    public static Stack<T> ToStack<T>(this IEnumerable<T> enumerable) => new Stack<T>(enumerable);

    public static Queue<T> ToQueue<T>(this IEnumerable<T> enumerable) => new Queue<T>(enumerable);
    ...
    public static DataTable ToDataTable<T>(this IEnumerable<T> items)
    {
        ...
        {
            tb.Columns.Add(property.Name, Nullable.GetUnderlyingType(property.PropertyType) ?? property.PropertyType);
        }
