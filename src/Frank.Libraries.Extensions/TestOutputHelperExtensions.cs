...
{
    public static void WriteLine<T>(this ITestOutputHelper outputHelper, IEnumerable<T> values) => outputHelper.WriteLine(ConsoleTable.From(values).ToMinimalString());
