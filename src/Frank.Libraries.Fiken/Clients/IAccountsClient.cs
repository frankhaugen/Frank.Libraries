...
{
    /// <summary>
    ///     Retrieves the specified bookkeping account. An account is a string with either four digits, or four digits, a colon
    ///     and five digits (\&quot;reskontro\&quot;).       Examples:       3020 and 1500:10001
    /// </summary>
    ...
    Task<Account> GetAccountAsync(int accountCode);
    ...
    AccountBalance GetAccountBalance(string accountCode, DateTime? date);

    /// <summary>
    ///     Retrieves the bookkeeping accounts and balances for a given date. An account is a string with either four digits,
    ///     or four digits, a colon and five digits (\&quot;reskontro\&quot;). Examples: 3020 and 1500:10001
    /// </summary>
    /// <param name="companySlug">Slug of company to retrieve</param>
    /// <param name="date">
    ///     Dates are represented as strings formatted as YYYY-MM-DD. Example: January 1st, 1970: \&quot;
    ...
    List<AccountBalance> GetAccountBalances(DateTime? date, long fromAccount = 0L, long toAccount = 1000L, int page = 0, int pageSize = 1000);
    ...
    Task<List<Account>> GetAccountsAsync(long fromAccount = 0L, long toAccount = 1000L, int page = 0, int pageSize = 1000);
}