...
public class InvoiceLineResult
{
    ...
    /// <summary>
    ///     Net amount of invoice line in cents in NOK if currency and amounts provided are in foreign currency. This is
    ///     calculated by Fiken.
    /// </summary>
    /// <value>
    ///     Net amount of invoice line in cents in NOK if currency and amounts provided are in foreign currency. This is
    ...
    /// <summary>
    ///     VAT amount of invoice line in cents in NOK if currency and amounts provided are in foreign currency. This is
    ///     calculated by Fiken.
    /// </summary>
    /// <value>
    ///     VAT amount of invoice line in cents in NOK if currency and amounts provided are in foreign currency. This is
    ...
    /// <summary>
    ///     Gross amount of invoice line in cents in NOK if currency and amounts provided are in foreign currency. This is
    ///     calculated by Fiken.
    /// </summary>
    /// <value>
    ///     Gross amount of invoice line in cents in NOK if currency and amounts provided are in foreign currency. This is
