...
public interface IContactsClient
{
    ...
    /// <summary>
    ///     Retrieves specified contact. ContactId is returned with a GET contacts call as the first returned field. ContactId
    ///     is returned in the Location response header for POST contact.
    /// </summary>
    /// <param name="companySlug">Slug of company to retrieve</param>
    /// <param name="contactId"></param>
    ...
    /// <param name="customer">
    ///     Returns all contacts that are customers. If filter is set for both supplier and customer &#x3D;
    ///     true, only contacts that are both supplier and customer will be returned.
    /// </param>
    /// <param name="supplier">
    ///     Returns all contacts that are suppliers. If filter is set for both supplier and customer &#x3D;
    ///     true, only contacts that are both supplier and customer will be returned.
    /// </param>
