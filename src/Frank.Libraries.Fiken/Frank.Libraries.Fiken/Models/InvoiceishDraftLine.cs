...
public class InvoiceishDraftLine
{
    ...
    /// <summary>
    ///     Percentage discount charged on invoice draft line. Should be a value between 0 and 100. Can be decimal values such
    ///     as 25.5
    /// </summary>
    /// <value>
    ///     Percentage discount charged on invoice draft line. Should be a value between 0 and 100. Can be decimal values
    ///     such as 25.5
    /// </value>
