...
namespace Frank.Libraries.Tests.Security.PasswordGeneration;

public class PasswordGeneratorHelperTests
{
    private readonly ITestOutputHelper _outputHelper;

    public PasswordGeneratorHelperTests(ITestOutputHelper outputHelper) => _outputHelper = outputHelper;
