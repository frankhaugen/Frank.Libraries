...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:ReceiptAdvice-2")]
[XmlRoot("ReceiptAdvice", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:ReceiptAdvice-2", IsNullable = false)]
public class ReceiptAdviceType
{
    ...
    {
        get => receiptAdviceTypeCodeField;
        set => receiptAdviceTypeCodeField = value;
    }
    ...
    {
        get => receiptLineField;
        set => receiptLineField = value;
    }
}