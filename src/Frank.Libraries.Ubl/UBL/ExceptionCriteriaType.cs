...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:ExceptionCriteria-2")]
[XmlRoot("ExceptionCriteria", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:ExceptionCriteria-2", IsNullable = false)]
public class ExceptionCriteriaType
{
    ...
    /// <remarks />
    [XmlElement("ExceptionCriteriaLine", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public ExceptionCriteriaLineType[] ExceptionCriteriaLine
    {
        get => exceptionCriteriaLineField;
        set => exceptionCriteriaLineField = value;
    }
}