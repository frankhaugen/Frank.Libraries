...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CatalogueItemSpecificationUpdate-2")]
[XmlRoot("CatalogueItemSpecificationUpdate", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CatalogueItemSpecificationUpdate-2", IsNullable = false)]
public class CatalogueItemSpecificationUpdateType
{
    ...
    /// <remarks />
    [XmlElement("CatalogueItemSpecificationUpdateLine", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public CatalogueItemSpecificationUpdateLineType[] CatalogueItemSpecificationUpdateLine
    {
        get => catalogueItemSpecificationUpdateLineField;
        set => catalogueItemSpecificationUpdateLineField = value;
    }
}