...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:TransportServiceDescriptionRequest-2" + "")]
[XmlRoot("TransportServiceDescriptionRequest", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:TransportServiceDescriptionRequest-2" + "", IsNullable = false)]
public class TransportServiceDescriptionRequestType
{
    ...
    {
        get => serviceInformationPreferenceCodeField;
        set => serviceInformationPreferenceCodeField = value;
    }
