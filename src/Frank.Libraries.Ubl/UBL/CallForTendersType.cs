...
public class CallForTendersType
{
    ...
    {
        get => legalDocumentReferenceField;
        set => legalDocumentReferenceField = value;
    }
    ...
    {
        get => technicalDocumentReferenceField;
        set => technicalDocumentReferenceField = value;
    }
