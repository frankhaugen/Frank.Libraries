...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:SelfBilledInvoice-2")]
[XmlRoot("SelfBilledInvoice", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:SelfBilledInvoice-2", IsNullable = false)]
