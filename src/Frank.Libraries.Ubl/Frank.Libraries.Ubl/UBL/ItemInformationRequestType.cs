...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:ItemInformationRequest-2")]
[XmlRoot("ItemInformationRequest", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:ItemInformationRequest-2", IsNullable = false)]
public class ItemInformationRequestType
{
    ...
    /// <remarks />
    [XmlElement("ItemInformationRequestLine", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public ItemInformationRequestLineType[] ItemInformationRequestLine
    {
        get => itemInformationRequestLineField;
        set => itemInformationRequestLineField = value;
    }
}