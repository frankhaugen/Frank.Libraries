...
[XmlRoot("SignatureInformation", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:SignatureAggregateComponents-2", IsNullable = false)]
public class SignatureInformationType
{
    ...
    {
        get => referencedSignatureIDField;
        set => referencedSignatureIDField = value;
    }
