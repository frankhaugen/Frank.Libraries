...
public class InventoryReportType
{
    ...
    /// <remarks />
    [XmlElement("InventoryReportLine", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public InventoryReportLineType[] InventoryReportLine
    {
        get => inventoryReportLineField;
        set => inventoryReportLineField = value;
    }
}