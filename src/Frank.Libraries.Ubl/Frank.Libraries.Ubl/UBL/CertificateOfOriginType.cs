...
public class CertificateOfOriginType
{
    ...
    /// <remarks />
    [XmlElement("EndorserParty", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    ...
    {
        get => certificateOfOriginApplicationField;
        set => certificateOfOriginApplicationField = value;
    }
    ...
    {
        get => issuerEndorsementField;
        set => issuerEndorsementField = value;
    }
    ...
    {
        get => embassyEndorsementField;
        set => embassyEndorsementField = value;
    }
    ...
    {
        get => insuranceEndorsementField;
        set => insuranceEndorsementField = value;
    }
}