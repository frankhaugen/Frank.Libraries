...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:SelfBilledCreditNote-2")]
[XmlRoot("SelfBilledCreditNote", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:SelfBilledCreditNote-2", IsNullable = false)]
public class SelfBilledCreditNoteType
{
    ...
    {
        get => statementDocumentReferenceField;
        set => statementDocumentReferenceField = value;
    }
    ...
    {
        get => creditNoteLineField;
        set => creditNoteLineField = value;
    }
}