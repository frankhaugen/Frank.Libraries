...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:TransportProgressStatus-2")]
[XmlRoot("TransportProgressStatus", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:TransportProgressStatus-2", IsNullable = false)]
public class TransportProgressStatusType
{
    ...
    {
        get => statusAvailableIndicatorField;
        set => statusAvailableIndicatorField = value;
    }
    ...
    {
        get => sourceIssuerPartyField;
        set => sourceIssuerPartyField = value;
    }
    ...
    {
        get => transportProgressStatusRequestDocumentReferenceField;
        set => transportProgressStatusRequestDocumentReferenceField = value;
    }
    ...
    /// <remarks />
    [XmlElement("TransportSchedule", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public TransportScheduleType[] TransportSchedule
    {
        get => transportScheduleField;
        set => transportScheduleField = value;
    }
}