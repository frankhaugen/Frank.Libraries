...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:DocumentStatusRequest-2")]
[XmlRoot("DocumentStatusRequest", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:DocumentStatusRequest-2", IsNullable = false)]
public class DocumentStatusRequestType
{
    ...
    {
        get => requestedDocumentReferenceField;
        set => requestedDocumentReferenceField = value;
    }
