...
[XmlRoot("AwardedNotification", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:AwardedNotification-2", IsNullable = false)]
public class AwardedNotificationType
{
    ...
    /// <remarks />
    [XmlElement("FinalFinancialGuarantee", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public FinancialGuaranteeType[] FinalFinancialGuarantee
    {
        get => finalFinancialGuaranteeField;
        set => finalFinancialGuaranteeField = value;
    }
