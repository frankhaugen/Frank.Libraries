...
[XmlRoot("ContractingActivity", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", IsNullable = false)]
public class ContractingActivityType
{
    ...
    {
        get => activityTypeCodeField;
        set => activityTypeCodeField = value;
    }
