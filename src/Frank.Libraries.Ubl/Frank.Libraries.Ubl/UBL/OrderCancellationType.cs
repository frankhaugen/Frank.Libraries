...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:OrderCancellation-2")]
[XmlRoot("OrderCancellation", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:OrderCancellation-2", IsNullable = false)]
