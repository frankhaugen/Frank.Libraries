...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:ExceptionNotification-2")]
[XmlRoot("ExceptionNotification", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:ExceptionNotification-2", IsNullable = false)]
public class ExceptionNotificationType
{
    ...
    /// <remarks />
    [XmlElement("ExceptionNotificationLine", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public ExceptionNotificationLineType[] ExceptionNotificationLine
    {
        get => exceptionNotificationLineField;
        set => exceptionNotificationLineField = value;
    }
}