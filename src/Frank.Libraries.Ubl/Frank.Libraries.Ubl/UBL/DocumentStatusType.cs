...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:DocumentStatus-2")]
[XmlRoot("DocumentStatus", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:DocumentStatus-2", IsNullable = false)]
public class DocumentStatusType
{
    ...
    {
        get => documentResponseField;
        set => documentResponseField = value;
    }

    /// <remarks />
    [XmlElement("AdditionalDocumentResponse", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public DocumentResponseType[] AdditionalDocumentResponse
    {
        get => additionalDocumentResponseField;
        set => additionalDocumentResponseField = value;
    }
}