...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:TendererQualificationResponse-2")]
[XmlRoot("TendererQualificationResponse", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:TendererQualificationResponse-2", IsNullable = false)]
public class TendererQualificationResponseType
{
    ...
    {
        get => resolutionDocumentReferenceField;
        set => resolutionDocumentReferenceField = value;
    }

    /// <remarks />
    [XmlElement("QualificationResolution", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public QualificationResolutionType[] QualificationResolution
    {
        get => qualificationResolutionField;
        set => qualificationResolutionField = value;
    }
