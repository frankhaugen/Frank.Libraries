...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:AttachedDocument-2")]
[XmlRoot("AttachedDocument", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:AttachedDocument-2", IsNullable = false)]
public class AttachedDocumentType
{
    ...
    {
        get => parentDocumentIDField;
        set => parentDocumentIDField = value;
    }
    ...
    {
        get => parentDocumentTypeCodeField;
        set => parentDocumentTypeCodeField = value;
    }
    ...
    {
        get => parentDocumentVersionIDField;
        set => parentDocumentVersionIDField = value;
    }
    ...
    /// <remarks />
    [XmlElement("ParentDocumentLineReference", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public LineReferenceType[] ParentDocumentLineReference
    {
        get => parentDocumentLineReferenceField;
        set => parentDocumentLineReferenceField = value;
    }
}