...
[XmlType(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:Forecast-2")]
[XmlRoot("Forecast", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:Forecast-2", IsNullable = false)]
public class ForecastType
{
    ...
    {
        get => basedOnConsensusIndicatorField;
        set => basedOnConsensusIndicatorField = value;
    }
    ...
    /// <remarks />
    [XmlElement("ForecastLine", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
    public ForecastLineType[] ForecastLine
    {
        get => forecastLineField;
        set => forecastLineField = value;
    }
}