...
public static class XsdTimeTool
{
    public static void IgnoreDateTimeSerializeAsString(CodeTypeDeclaration codeDeclTimeType)
    {
        ...
        var valueMember = codeDeclTimeType.Members.Cast<CodeTypeMember>()
        ...
        var commentLine = "New serialized string type is declared in file UBL-UnqualifiedDataTypes-2.1.partial.cs";
        var memberCommentStatement = new CodeCommentStatement(commentLine, false);
        ...
        var debuggerStepThroughAttribute = codeDeclTimeType.CustomAttributes.OfType<CodeAttributeDeclaration>()
                                                           .Where(a => a.Name == "System.Diagnostics.DebuggerStepThroughAttribute")
                                                           .SingleOrDefault();
