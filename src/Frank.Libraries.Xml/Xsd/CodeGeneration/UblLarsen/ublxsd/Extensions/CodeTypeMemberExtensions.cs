...
public static class CodeTypeMemberExtensions
{
    public static CodeAttributeArgument GetNamespaceAttributeArgument(this CodeTypeMember @this) =>
        @this.CustomAttributes.OfType<CodeAttributeDeclaration>()
             .Where(d => d.Name == "System.Xml.Serialization.XmlTypeAttribute")
             .Single()
             .Arguments.Cast<CodeAttributeArgument>()
             .Where(a => a.Name == "Namespace")
             .Single();
    ...
    public static XmlQualifiedName GetQualifiedName(this CodeTypeMember @this)
    {
        ...
        {
            var name = GetNameWithoutTrailingDigits(@this);
            var codeDeclTargetNamespace = ((CodePrimitiveExpression)GetNamespaceAttributeArgument(@this)
    ...
    public static bool HasAnyXmlTextAttribute(this CodeTypeMember @this) => @this.CustomAttributes.Cast<CodeAttributeDeclaration>()
                                                                                 .Any(a => a.Name == "System.Xml.Serialization.XmlTextAttribute");

    public static XmlSchema GetSchema(this CodeTypeMember @this) => @this.UserData[Constants.XmlSchemaLabel] as XmlSchema;

    public static XmlSchemaType GetXmlSchemaType(this CodeTypeMember @this) => @this.UserData[Constants.XmlSchemaTypeLabel] as XmlSchemaType;
    ...
    {
        var xmlComplexType = GetXmlSchemaType(@this) as XmlSchemaComplexType;
        ...
        if (content != null)
        {
            ...
            return (restriction?.Attributes ?? extension.Attributes).Cast<XmlSchemaAttribute>()
                                                                    .Any(a => a.Use == XmlSchemaUse.Required);
        }

        return xmlComplexType.Attributes.Cast<XmlSchemaAttribute>()
                             .Any(a => a.Use == XmlSchemaUse.Required);
    }
}