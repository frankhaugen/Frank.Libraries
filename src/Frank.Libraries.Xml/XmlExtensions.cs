...
public static class XmlExtensions
{
    ...
    /// <summary>
    ///     Deserializes an object which is saved to an XML data string. If the object has no instance a new object will be
    ///     constructed if possible.
    ///     <note type="note">
    ///         An exception will occur if a null reference is called an no valid constructor of the class is
    ///         available.
    ///     </note>
    /// </summary>
    ...
    /// <summary>
    ///     Tries to deserializes an object which is saved to an XML data string. If the object has no instance a new object
    ///     will be constructed if possible.
    ///     <note type="note">
    ///         An exception will occur if a null reference is called an no valid constructor of the class is
    ///         available.
    ///     </note>
