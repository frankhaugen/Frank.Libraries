...
public class PasswordHasher
{
    ...
    public PasswordHasher(PasswordHashingConfiguration configuration) => _configuration = configuration;

    /// <summary>
    ///     Instantiate with default configuration
    /// </summary>
    public PasswordHasher() => _configuration = new PasswordHashingConfiguration();
