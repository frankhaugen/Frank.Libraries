...
public class TimezoneService
{
    ...
    public TimezoneService(IClock clock) => _clock = clock;
    ...
    {
        if (DateTimeZoneProviders.Tzdb.GetZoneOrNull(ianaName) == null)
        {
            throw new TimeZoneNotFoundException($"The timezone '{ianaName}' does not exist");
        }
