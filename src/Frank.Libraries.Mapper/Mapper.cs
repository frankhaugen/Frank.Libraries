...
namespace Frank.Libraries.Mapper
{
    public class Mapper
    {
        ...
        private void SetFieldValue<T>(T destination, FieldInfo field, object? value)
        {
            field.SetValue(destination, value);
        }

        private void SetPropertyValue<T>(T destination, PropertyInfo property, object? value)
        {
