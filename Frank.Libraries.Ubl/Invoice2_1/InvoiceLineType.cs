namespace Frank.Libraries.Ubl.Invoice2_1
{
    ...
    public partial class InvoiceLineType
    {
        ...
        private TaxTotalType[] _withholdingTaxTotalField;
        ...
        private InvoiceLineType[] _subInvoiceLineField;
        ...
        public TaxTotalType[] WithholdingTaxTotal
        {
            get
            {
                return _withholdingTaxTotalField;
            }
            set
            {
                _withholdingTaxTotalField = value;
            }
        }
        ...
        public InvoiceLineType[] SubInvoiceLine
        {
            get
            {
                return _subInvoiceLineField;
            }
            set
            {
                _subInvoiceLineField = value;
            }
        }
