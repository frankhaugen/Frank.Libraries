...
namespace Frank.Libraries.IRC
{
    ...
    partial class IrcClient
    {
        ...
        /// <summary>
        /// Sends the password for registering the connection. This message must only be sent before the actual registration, which is done by <see cref="SendMessageUser"/> (for normal users) or <see cref="SendMessageService"/> (for services).
        /// </summary>
        ...
        /// <param name="distribution">A wildcard expression for matching against server names, which determines where the service is visible.</param>
        ...
        /// </summary>
        /// <param name="channels">A collection of the names of channels for which to list users, or <see langword="null"/> for all channels.</param>
        ...
        /// </summary>
        /// <param name="channelsUsers">A collection of 2-tuples of channel names and the nick names of the users to kick from the channel.</param>
        /// <param name="comment">The comment to send the server, or <see langword="null"/> for none.</param>
        ...
        /// </summary>
        /// <param name="serverMask">A wildcard expression for matching against the names of servers, or <see langword="null"/> to match the entire network.</param>
        /// <param name="targetServer">The name of the server to which to forward the message, or <see langword="null"/> for the current server.</param>
        ...
        /// </summary>
        /// <param name="text">The text of the away message. The away message is sent to any user that tries to contact the local user while it is away.</param>
